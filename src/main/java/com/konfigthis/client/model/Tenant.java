...
public class Tenant {
  ...
  public Tenant tenantCode(String tenantCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The status of the data transfer for this tenant.")
  ...
  public Tenant sources(List<Source> sources) {
  ...
  public Tenant addSourcesItem(Source sourcesItem) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A list of objects representing the sources that data was pushed to and their data transfer results.")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tenantCode, tenant.tenantCode) &&
        Objects.equals(this.status, tenant.status) &&
        Objects.equals(this.sources, tenant.sources)&&
        Objects.equals(this.additionalProperties, tenant.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tenantCode, status, sources, additionalProperties);
  }
      ...
      if (jsonObj.get("sources") != null && !jsonObj.get("sources").isJsonNull()) {
        ...
        if (jsonArraysources != null) {
          ...
          for (int i = 0; i < jsonArraysources.size(); i++) {
            Source.validateJsonObject(jsonArraysources.get(i).getAsJsonObject());
          };
        }
      }
  }
